			...
			<div class="row" style="margin-bottom: 25%;">
				<div class="col-md-12">
					<div class="error-template">
						<h1>Oops!</h1>
						<h2 class="text-danger">Erreur lors de l'envoi du mail.</h2>
						<div class="error-details">Commande annulée, re-essayez plus tard!</div>
						<div class="error-actions">
							<a href="<%=request.getContextPath()%>/"
								class="btn btn-primary btn-lg btn-md btn-sm btn-xs"><span
								class="glyphicon glyphicon-home"></span> Page d'accueil.</a>
						</div>
					</div>
				</div>
			</div>
